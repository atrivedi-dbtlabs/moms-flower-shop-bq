...
weekly_active_users AS (
    ...
    GROUP BY DATE_TRUNC(event_time, WEEK), platform
),
...
final AS (
    SELECT 
        ...
        (CAST(new_visits - LAG(new_visits) OVER (PARTITION BY platform, campaign_type ORDER BY week_start) AS NUMERIC)
